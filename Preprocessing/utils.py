...
def create_cropping_jpg(img_path):
  ...
  for i, contour in enumerate(seeds):
      ...
      contour_image = image[centroid_y - 120: centroid_y + 120, centroid_x - 63: centroid_x + 63]
...
# path_rgb = 'dataset_v1\A9-30-1-21_22_K\A9-30-1_KSP_21_22_CD1.JPG'
